...
def draw_frame_scenario_1(image_scenario_1, window_width, window_heigth, window, Image_waste, state_elements):
    ...
    if state_elements["casca_banana"] == 0:
        resized_image = pygame.transform.scale(Image_waste['casca_banana'], (int(window_heigth/6.4), int(window_heigth/6.4)))  # Redimensiona a imagem se necessário
    ...
    if state_elements["jornal"] == 0:
        resized_image = pygame.transform.scale(Image_waste['jornal'], (int(window_heigth/5.3), int(window_heigth/5.3)))  # Redimensiona a imagem se necessário
    ...
    if state_elements["lata_refrigerante"] == 0:
        resized_image = pygame.transform.scale(Image_waste['lata_refrigerante'], (int(window_heigth/5.62), int(window_heigth/5.62)))  # Redimensiona a imagem se necessário
    ...
    elif (state_elements["casca_banana"] + state_elements["jornal"] + state_elements["lata_refrigerante"]) == 6:
