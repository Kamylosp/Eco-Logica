...
def draw_frame_scenario_3(image_scenario_3, window_width, window_heigth, window, font_title_eco_logica, Image_waste):
    # Image as background
    background_3 = pygame.transform.scale(image_scenario_3, (window_width, window_heigth))
    window.blit(background_3, (0,0))

    # Title Eco-Logica
    text = font_title_eco_logica.render("Cenario 3", True, (255, 0, 0))
